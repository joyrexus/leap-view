...
(function() {
  var R2D, draw, i, parse, pitch, points, roll, yaw;
  ...
  this.render = function(queue) {
    var duration, last, run, start, step, stop;
    last = queue.length - 1;
    stop = queue[last].timestamp;
    this.startTime = start = queue[0].timestamp;
    ...
    run = function() {
      ...
      time = (queue[frame].timestamp - start) / 1000000;
